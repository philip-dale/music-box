...
Rotary encoder is attached to pins 3,4,5. The clk pin has to be connected to a pin with an interupt. This is used to controll the speed of teh songs. faster you turn the faster they play. If not turning, it will not play.
...
mp3s in music folder are my own recodings of a toy xylophone.